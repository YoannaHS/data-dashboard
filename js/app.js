...
iconMenu.addEventListener('click', showMenu);
 ...
 function showMenu(event) {
   ...
   var firstBox = document.createElement('img');
   firstBox.src = 'https://github.com/SteffAhv/data-dashboard/blob/menu-usuario/assets/images/2222.png?raw=true';
   firstBox.classList.add('user-info');
   userMenu.classList.add('menu-box');
   userMenu.appendChild(firstBox);

   userMenu.appendChild(event.target);
